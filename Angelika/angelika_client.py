...
THEATERS = [
    ...
    ("Angelika Film Center Mosaic", "mosaic", "https://angelikafilmcenter.com/mosaic/now-playing"),
    ("Angelika Film Center Dallas", "dallas", "https://angelikafilmcenter.com/dallas/now-playing"),
]
